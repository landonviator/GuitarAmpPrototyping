...
/**
*/
class Guitar_Amp_PrototypeAudioProcessorEditor  : public juce::AudioProcessorEditor
{
public:
    Guitar_Amp_PrototypeAudioProcessorEditor (Guitar_Amp_PrototypeAudioProcessor&);
    ~Guitar_Amp_PrototypeAudioProcessorEditor() override;
...
private:
    ...
    Guitar_Amp_PrototypeAudioProcessor& audioProcessor;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Guitar_Amp_PrototypeAudioProcessorEditor)
};
