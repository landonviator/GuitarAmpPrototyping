...
/**
*/
class Guitar_Amp_Prototype_Intel_MacAudioProcessorEditor  : public juce::AudioProcessorEditor
{
public:
    Guitar_Amp_Prototype_Intel_MacAudioProcessorEditor (Guitar_Amp_Prototype_Intel_MacAudioProcessor&);
    ~Guitar_Amp_Prototype_Intel_MacAudioProcessorEditor() override;
...
private:
    ...
    Guitar_Amp_Prototype_Intel_MacAudioProcessor& audioProcessor;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Guitar_Amp_Prototype_Intel_MacAudioProcessorEditor)
};
