...
//==============================================================================
Guitar_Amp_Prototype_Intel_MacAudioProcessor::Guitar_Amp_Prototype_Intel_MacAudioProcessor()
...
juce::AudioProcessorValueTreeState::ParameterLayout Guitar_Amp_Prototype_Intel_MacAudioProcessor::createParameterLayout()
{
...
//==============================================================================
const juce::String Guitar_Amp_Prototype_Intel_MacAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool Guitar_Amp_Prototype_Intel_MacAudioProcessor::acceptsMidi() const
{
...
bool Guitar_Amp_Prototype_Intel_MacAudioProcessor::producesMidi() const
{
...
bool Guitar_Amp_Prototype_Intel_MacAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double Guitar_Amp_Prototype_Intel_MacAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int Guitar_Amp_Prototype_Intel_MacAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int Guitar_Amp_Prototype_Intel_MacAudioProcessor::getCurrentProgram()
{
    return 0;
}

void Guitar_Amp_Prototype_Intel_MacAudioProcessor::setCurrentProgram (int index)
{
}

const juce::String Guitar_Amp_Prototype_Intel_MacAudioProcessor::getProgramName (int index)
{
    return {};
}

void Guitar_Amp_Prototype_Intel_MacAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void Guitar_Amp_Prototype_Intel_MacAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void Guitar_Amp_Prototype_Intel_MacAudioProcessor::releaseResources()
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool Guitar_Amp_Prototype_Intel_MacAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void Guitar_Amp_Prototype_Intel_MacAudioProcessor::updatePreClipFilter(const float &freq){
    *preClipFilter.state = *juce::dsp::IIR::Coefficients<float>::makePeakFilter(lastSampleRate, freq, 0.5, 6.0);
}

void Guitar_Amp_Prototype_Intel_MacAudioProcessor::updateLowFilter(const float &gain){
    *lowFilter.state = *juce::dsp::IIR::Coefficients<float>::makeLowShelf(lastSampleRate, 200, 1.3, pow(10, gain * 0.05));
}

void Guitar_Amp_Prototype_Intel_MacAudioProcessor::updateMidFilter(const float &gain){
    *midFilter.state = *juce::dsp::IIR::Coefficients<float>::makePeakFilter(lastSampleRate, 815, 0.3, pow(10, gain * 0.05));
}

void Guitar_Amp_Prototype_Intel_MacAudioProcessor::updateHighFilter(const float &gain){
    *highFilter.state = *juce::dsp::IIR::Coefficients<float>::makePeakFilter(lastSampleRate, 6000, 0.2, pow(10, gain * 0.05));
}

//==============================================================================
bool Guitar_Amp_Prototype_Intel_MacAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* Guitar_Amp_Prototype_Intel_MacAudioProcessor::createEditor()
{
    return new Guitar_Amp_Prototype_Intel_MacAudioProcessorEditor (*this);
}

//==============================================================================
void Guitar_Amp_Prototype_Intel_MacAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
    juce::MemoryOutputStream stream(destData, false);
    treeState.state.writeToStream (stream);
}

void Guitar_Amp_Prototype_Intel_MacAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new Guitar_Amp_Prototype_Intel_MacAudioProcessor();
}
